    ...
    >
      ...
      >
        ...
        <p className="text-sm leading-relaxed text-white/70 mb-6">
          Gracias por solicitar una valoración. En el siguiente paso se abrirá WhatsApp
          para que uno de nuestros especialistas continúe tu atención.
        </p>
        ...
        >
          <div className="flex justify-between gap-4">
            <span className="text-xs tracking-wider uppercase text-white/50">Nombre</span>
            <span className="text-sm text-white text-right">{name}</span>
          </div>
          <div className="flex justify-between gap-4">
            <span className="text-xs tracking-wider uppercase text-white/50">Teléfono</span>
            <span className="text-sm text-white text-right">{phone}</span>
          </div>
          <div className="flex justify-between gap-4">
            <span className="text-xs tracking-wider uppercase text-white/50">Tratamiento</span>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          >
            <MessageCircle size={15} /> Continuar en WhatsApp
          </button>
        </div>
      </div>
    </div>

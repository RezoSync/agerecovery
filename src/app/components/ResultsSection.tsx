...
const testimonials = [
  {
    ...
    text:
      "El Dr. García transformó mi rostro de manera increíble. Sus manos son expertas y los resultados son totalmente naturales. Me siento 10 años más joven.",
    stars: 5,
  },
  {
    name: "Claudia M.",
    ...
    svc: "Hilos Tensores",
    text:
      "Venía con muchas dudas sobre los hilos tensores y el doctor me explicó todo con mucha paciencia. El resultado superó todas mis expectativas.",
    stars: 5,
  },
  {
    name: "Patricia L.",
    ...
    svc: "Botox",
    text:
      "Llevo 3 años siendo paciente del Dr. García y no cambiaría a nadie. Su técnica es impecable y siempre mantiene los gestos naturales.",
    stars: 5,
  },
];
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-8">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs tracking-[0.25em] uppercase text-cyan">Resultados reales</span>
          </div>
        ...
        <div key={tab} className="grid md:grid-cols-2 gap-8" style={{ animation: "fadeIn 0.35s both" }}>
          <div className="flex flex-col gap-3">
            ...
            {tab < 2 && (
              <p className="text-xs italic text-cyan-light">
        ...
        <div className="mt-20">
          <div className="flex items-center gap-3 mb-10">
            <span className="h-px w-8 bg-cyan" />
            <span className="text-xs tracking-[0.25em] uppercase text-cyan">Testimonios</span>
          </div>

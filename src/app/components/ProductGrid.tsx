      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        ...
        >
          ...
          <p className="text-base text-white/60 leading-relaxed mt-5 max-w-lg">
            Cada tratamiento parte de un diagnóstico individual: construimos el plan facial
            según tu biotipo de piel, tu edad biológica y tus metas estéticas.
          </p>
        </motion.div>
          ...
          {services.map((s, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  Conocer protocolo <ChevronRight size={12} />
                </Link>
              </motion.div>
            );
          })}
